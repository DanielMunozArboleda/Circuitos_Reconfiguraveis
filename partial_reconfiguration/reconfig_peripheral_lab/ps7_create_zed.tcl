start_gui
create_project reconfig_peripheral_zed_lab ./reconfig_peripheral_zed_lab -part xc7z020clg484-1
...
make_wrapper -files [get_files ./reconfig_peripheral_zed_lab/reconfig_peripheral_zed_lab.srcs/sources_1/bd/system/system.bd] -top
add_files -norecurse ./reconfig_peripheral_zed_lab/reconfig_peripheral_zed_lab.srcs/sources_1/bd/system/hdl/system_wrapper.v
update_compile_order -fileset sources_1
update_compile_order -fileset sim_1
save_bd_design
# set_property generate_synth_checkpoint true [get_files  ./reconfig_peripheral_zed_lab/reconfig_peripheral_zed_lab.srcs/sources_1/bd/system/system.bd]
